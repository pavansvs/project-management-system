            ...
            <div style="background-color: beige; margin-left: 33%; alignment-adjust: central; width: 35%">
              ...
              <table align="center" width="100%" cellspacing="00" cellpadding="03">
                ...
                <tr>
                  ...
                  <td><input id="in" type="text" name="sid" value="<?php echo $sid; ?>" /></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  ...
                  <td><input id="in" type="text" name="stname" value="<?php echo  $name; ?>" /></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  ...
                  <td><input id="in" type="email" name="stemail" value="<?php echo $email; ?>" /></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  ...
                  <td><input id="in" type="text" name="stphone" value="<?php echo  $phone; ?>" /></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  ...
                  <td><input id="in" type="password" name="stpass" value="<?php echo $password; ?>" /></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  ...
                  <td><input id="in" type="text" name="styear" value="<?php echo  $year; ?>" /></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
