          ...
          <div style="background-color: beige; margin-left: 33%; alignment-adjust: central; width: 35%">
            <table align="center" width="100%" cellspacing="00" cellpadding="05">
              ...
              <tr>
                ...
                <td><input id="in" type="text" name="fid" value="<?php echo $fid; ?>" /></td>
                <td>&nbsp;</td>
              </tr>
              ...
              <tr>
                ...
                <td><input id="in" type="text" name="faname" value="<?php echo $name; ?>" /></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                ...
                <td><input id="in" type="email" name="faemail" value="<?php echo $email ?>" /></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                ...
                <td><input id="in" type="text" name="faphone" value="<?php echo $phone; ?>" /></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                ...
                <td><input id="in" type="password" name="fapass" value="<?php echo $password; ?>" /></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                ...
                <td><input id="in" type="text" name="faqualification" value="<?php echo $qualification; ?>" /></td>
                <td>&nbsp;</td>
              </tr>
